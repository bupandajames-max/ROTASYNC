...
export default function RosterGrid({
  ...
  const loadHistoryCycles = async () => {
    ...
    try {
      ...
      // rejected by Firestore rules for non-super users). Only attempt the
      // cloud read when actually signed in: in the no-login demo/sandbox
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
        <div>
          ...
          <h2 className="text-[#1f3864] text-xl font-black font-sans flex items-center gap-2">
            Roster &amp; Schedule
            {isGridLocked ? (
              ...
              <span className="text-xs bg-rose-50 text-[#1f3864] px-2.5 py-0.5 rounded-full font-bold flex items-center gap-1 border border-rose-100">
            ...
            <>
              {openOnboarding && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-[#1f3864] border border-indigo-200/50 rounded-xl font-bold text-xs shadow-xs transition-colors cursor-pointer"
                  title="Add a staff member step by step"
                >
                  <UserPlus className="w-3.5 h-3.5 text-[#009EE2]" />
                  Onboard New Staff
                </button>
              )}
              <button
                onClick={openWizard}
                className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-[#101d35] to-[#1f3864] hover:from-[#1f3864] hover:to-[#101d35] text-white border border-[#009EE2]/40 rounded-xl font-bold text-xs shadow-sm transition-all cursor-pointer"
              >
              ...
              <form onSubmit={handleApplyCustomDates} className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-white p-5 rounded-2xl border border-slate-100/80">
                    ...
                    <button
                      ...
                      className={`px-3 py-2.5 rounded-xl text-xs font-bold border transition-all text-center cursor-pointer ${
                        cyclePreset === 'fifteenToFourteen'
                          ? 'bg-[#1f3864] text-white border-transparent'
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="px-3.5 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#1f3864] bg-[#fdfdfd] text-gray-900 font-mono font-bold shadow-xs"
                    required
                  />
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="px-3.5 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#1f3864] bg-[#fdfdfd] disabled:bg-slate-50 disabled:text-slate-450 text-gray-900 font-mono font-bold shadow-xs"
                    required
                  />
                </div>
                ...
                <div className="md:col-span-4 flex justify-end gap-2 border-t border-slate-100 pt-4 mt-2">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 bg-[#1f3864] hover:bg-[#13233e] text-white rounded-xl text-xs font-black shadow-xs cursor-pointer transition-colors"
                  >
                    Save date changes
                  </button>
                </div>
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="mt-1.5 flex flex-col gap-1">
                              <div className="flex justify-between items-center text-[11px]">
                                ...
                                {overtimeHours > 0 ? (
                                  <span className="text-[#1f3864] font-black uppercase font-mono tracking-tight text-[10px] bg-red-50 px-1 border border-red-100 rounded-sm">+{overtimeHours}h OT</span>
                            ...
                            {!activeCycle.isLocked && bulkUpdateShifts && (
                              <div className="mt-2.5 flex items-center gap-1 bg-slate-50 p-1 rounded-lg border border-slate-100 opacity-60 group-hover:opacity-100 transition-opacity">
                                <button
                                  ...
                                  className="p-1 hover:bg-white rounded text-slate-500 hover:text-[#1f3864] transition-all cursor-pointer grow flex justify-center"
                                >
                        ...
                        {cycleDates.map((_dKey, dIdx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isDraggedOver && (
                                <div className="absolute inset-0 bg-[#1f3864]/20 border-2 border-dashed border-[#1f3864] pointer-events-none flex items-center justify-center animate-pulse z-30">
                                  <span className="text-[10px] bg-white text-[#1f3864] px-1 py-0.5 rounded font-black border border-[#1f3864]/30 shadow-sm font-sans">
                                    Drop Shift
                                  </span>
                                </div>
                              )}
                ...
                <form onSubmit={handleCreateSnapshot} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className="px-3 py-2 text-xs border border-gray-250 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#1f3864] bg-[#fdfdfd] text-gray-900 font-semibold shadow-xs"
                      required
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className="px-3 py-2 text-xs border border-gray-250 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#1f3864] bg-[#fdfdfd] text-gray-900 font-mono shadow-xs"
                      required
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-1 justify-end">
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-1.5 px-4 py-2 bg-[#1f3864] hover:bg-[#13233e] text-white rounded-xl font-bold text-xs transition-all cursor-pointer shadow-sm md:h-10 border border-transparent hover:border-[#009EE2]/20"
                    >
